...
def audio_samples_interface():
    with gr.Blocks(css="""
        ...
        .gr-row { display: flex; flex-wrap: wrap; justify-content: center; gap: 20px; }
    ...
    """) as demo:
        ...
        with gr.Tab("MusicGen"):
            ...
            with gr.Row():
                create_audio_component("Sample 1", "mg1.wav", "Original Classical Version")
                create_audio_component("Sample 2", "mg2.wav", "Rock Adaptation")
                create_audio_component("Sample 3", "mg3.wav", "Fusion of Classical & Rock")
